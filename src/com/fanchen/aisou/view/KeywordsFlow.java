...
public class KeywordsFlow extends FrameLayout implements OnGlobalLayoutListener {
	...
	/** 存储显示的关键字。 */
	private String[] colors={"#4CCFAD","#D9746F","#8c000000","#8cDEC783","#8c466651","#8cD9A444","#8c0385AD","#8cCC6B61","#F4F1DF",""};
	...
	private boolean show() {
		if (width > 0 && height > 0 && vecKeywords != null
			...
			for (int i = 0; i < size; i++) {
				...
				txt.setText(keyword);
				String c=colors[random.nextInt(colors.length-1)];
				txt.setTextColor(Color.parseColor(c));
