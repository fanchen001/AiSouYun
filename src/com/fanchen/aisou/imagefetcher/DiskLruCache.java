...
package com.fanchen.aisou.imagefetcher;
...
import com.fanchen.aisou.utils.AppUtil;
...
public class DiskLruCache {
	...
	public static DiskLruCache openCache(Context context, File cacheDir, long maxByteSize) {
		...
		if (cacheDir.isDirectory() && cacheDir.canWrite() && AppUtil.getUsableSpace(cacheDir) > maxByteSize) {
	...
	public static File getDiskCacheDir(Context context, String uniqueName) {
		...
		final String cachePath = Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED || !AppUtil.isExternalStorageRemovable() ? AppUtil
	...
	private boolean writeBitmapToFile(Bitmap bitmap, String file) throws IOException, FileNotFoundException {
		...
		try {
			out = new BufferedOutputStream(new FileOutputStream(file), AppUtil.IO_BUFFER_SIZE);
