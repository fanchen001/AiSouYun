...
public class ImageFetcher extends ImageResizer {
    ...
    public static File downloadBitmap(Context context, String urlString) {
        ...
        try {
            ...
            final InputStream in = new BufferedInputStream(urlConnection.getInputStream(), AppUtil.IO_BUFFER_SIZE);
            out = new BufferedOutputStream(new FileOutputStream(cacheFile), AppUtil.IO_BUFFER_SIZE);
            int b;
            while ((b = in.read()) != -1) {
                out.write(b);
            }
